...
pos = [
    ...
    [TURN_OUTER, FRONT, TURN_OUTER, -TURN_INNER, -BACK, -TURN_INNER, LO, HI, LO, HI, LO, HI],
    [TURN_OUTER, FRONT, TURN_OUTER, -TURN_INNER, -BACK, -TURN_INNER, HI, HI, HI, HI, HI, HI],
    [TURN_OUTER, FRONT, TURN_OUTER, -TURN_INNER, -BACK, -TURN_INNER, HI, LO, HI, LO, HI, LO],
    [FRONT, TURN_OUTER, FRONT, -BACK, -TURN_INNER, -BACK, HI, LO, HI, LO, HI, LO],
    [FRONT, TURN_OUTER, FRONT, -BACK, -TURN_INNER, -BACK, HI, HI, HI, HI, HI, HI],
    [FRONT, TURN_OUTER, FRONT, -BACK, -TURN_INNER, -BACK, LO, HI, LO, HI, LO, HI]
]
